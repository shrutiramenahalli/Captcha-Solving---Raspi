...
def main():
    ...
    if args.train_dataset is None:
        args.train_dataset = '/users/pgrad/ramenahs/PycharmProjects/ScalableComputing/sample-code/Raspi/output'
        # print("Please specify the path to the training data set")
        # exit(1)

    if args.validate_dataset is None:
        args.validate_dataset ='/users/pgrad/ramenahs/PycharmProjects/ScalableComputing/sample-code/Raspi/val'
        # print("Please specify the path to the validation data set")
        # exit(1)

    if args.output_model_name is None:
        args.output_model_name = 'Captcha_Identifier1'
    ...
    # with tf.device('/device:XLA_CPU:0'):
        ...
        log_dir = "/users/pgrad/ramenahs/PycharmProjects/ScalableComputing/sample-code/Raspi" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
